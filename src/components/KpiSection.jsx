...
export default function KPISection() {
  ...
  const content = {
    Traffic: {
      ...
      image:
        "https://techdigitics.com/wp-content/uploads/2025/08/PPC-1.webp",
      items: [
    ...
    Branding: {
      ...
      image:
        "https://techdigitics.com/wp-content/uploads/2025/08/seo-1.webp",
      items: [
    ...
    "Cut Down CPL": {
      ...
      button: "Reduce CPL →",
      image:
        "https://techdigitics.com/wp-content/uploads/2025/08/SMO.webp",
      items: [
    ...
    "Turn Clicks Into Leads": {
      ...
      image:
        "https://techdigitics.com/wp-content/uploads/2025/08/New-Project-1-1.webp",
      items: [
    ...
    "Increase ROI/ROAS": {
      ...
      button: "Boost ROI →",
      image:
        "https://techdigitics.com/wp-content/uploads/2025/08/New-Project-2-1.webp",
      items: [
  ...
  return (
    <div className="w-full bg-white py-16 px-4 flex flex-col items-center">
      ...
      <p className="text-gray-600 text-center max-w-3xl mt-3 mb-8">
      ...
      {/* Tabs */}
      <div className="flex border border-gray-200 rounded-lg overflow-hidden mb-10">
        {tabs.map((tab) => (
          <button
            key={tab}
            onClick={() => setActive(tab)}
            className={`px-6 py-3 text-sm font-medium border-r last:border-0 transition
              ${
                active === tab
      ...
      {/* Main Card */}
      <div
        className="w-full max-w-6xl bg-gradient-to-r from-red-100/50 to-red-50 shadow-xl 
        rounded-3xl p-10 flex flex-col md:flex-row gap-10"
      >
        {/* LEFT TEXT */}
        <div className="w-full md:w-1/2">
          ...
          <button
            className="bg-gradient-to-r from-red-500 to-red-400 hover:opacity-90 
        ...
        <div className="w-full md:w-1/3 flex flex-col gap-4">
          {content[active].items.map((text, index) => (
            <div
              key={index}
              className="p-4 bg-white rounded-xl border text-gray-700 shadow-sm"
            >
              {text}
            </div>
          ))}
